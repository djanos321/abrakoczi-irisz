...
exports.tantargyTarifiakcioListazasa = (req, res) => {
  const { tanszekekId, oldal, meret, tantargyakId, munkatarsakId, felev, kepzesi_forma } = req.body;
  var condition = {
    [Op.and]: [
...
exports.tanarTerhelesListazasa = (req, res) => {
  const { oldal, meret, id, tanszekekId } = req.body;
  var condition = {
    [Op.and]: [
...
exports.gyorsitas = (req, res) => {
  sequelize.query(`
  TRUNCATE TABLE tantargy_tarifikaciok;`)        

  sequelize.query(`INSERT INTO tantargy_tarifikaciok (id, felev, kredit, tipus, kepzesi_forma, hallgatok_szama, eloadas, szeminarium, laboratoriumi, createdAt, updatedAt, tantargyakId, munkatarsakId, szeminarium_munkatarsakId) VALUES
  (1, '2', 6, 'beszámoló', 'nappali', 2, 0, 52, 0, '2022-06-14 22:03:53', '2022-06-14 22:13:58', 22, NULL, 26),
  (2, '2', 6, 'beszámoló', 'nappali', 1, 28, 28, 0, '2022-06-14 22:03:53', '2022-06-14 22:14:06', 39, 26, 13),
  (4, '2', 5, 'vizsga', 'nappali', 3, 13, 25, 0, '2022-06-14 22:03:53', '2022-06-14 22:15:29', 16, 14, 27),
  (5, '2', 3, 'beszámoló', 'nappali', 3, 14, 16, 0, '2022-06-14 22:03:53', '2022-06-14 22:15:19', 24, 2, 2),
  (6, '2', 3, 'beszámoló', 'nappali', 3, 15, 15, 0, '2022-06-14 22:03:53', '2022-06-14 22:12:28', 27, 18, 18),
  (7, '2', 3, 'vizsga', 'nappali', 3, 11, 14, 0, '2022-06-14 22:03:53', '2022-06-14 22:14:52', 29, 26, 26),
  (12, '2', 6, 'beszámoló', 'levelező', 2, 28, 28, 0, '2022-06-14 22:07:31', '2022-06-14 22:16:09', 39, 26, NULL),
  (14, '2', 5, 'vizsga', 'levelező', 2, 13, 25, 0, '2022-06-14 22:07:31', '2022-06-14 22:16:46', 16, 27, NULL),
  (15, '2', 3, 'beszámoló', 'levelező', 2, 14, 16, 0, '2022-06-14 22:07:31', '2022-06-14 22:16:30', 24, 2, NULL),
  (16, '2', 3, 'beszámoló', 'levelező', 2, 15, 15, 0, '2022-06-14 22:07:31', '2022-06-14 22:16:17', 27, 18, NULL),
  (17, '2', 3, 'vizsga', 'levelező', 2, 11, 14, 0, '2022-06-14 22:07:31', '2022-06-14 22:16:40', 29, 26, NULL),
  (21, '2', 3, 'vizsga', 'nappali', 6, 20, 10, 0, '2022-06-14 22:08:27', '2022-06-14 22:15:47', 40, 28, 28),
  (22, '2', 3, 'vizsga', 'levelező', 3, 20, 10, 0, '2022-06-14 22:09:29', '2022-06-14 22:16:51', 40, 28, NULL);`)
      .then(message => {
