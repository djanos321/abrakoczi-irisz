...
const vezerlo = require("../controllers/szakdolgozat_evfolyammunka_tarifikaciok.admin.controller");
module.exports = function (app) {
  ...
  utvonal.get("/", [adminisztracios_munkatarsak_authJwt.verifyToken, adminisztracios_munkatarsak_authJwt.isBossOrAdminOrStudyDepartment], vezerlo.szakdolgozatEvfolyammunkaTarifikacioListazasa);

  utvonal.get("/osszeg_bsc", [adminisztracios_munkatarsak_authJwt.verifyToken, adminisztracios_munkatarsak_authJwt.isBossOrAdminOrStudyDepartment], vezerlo.kiosztottDiakokSzamaBsc);

  utvonal.get("/osszeg_msc", [adminisztracios_munkatarsak_authJwt.verifyToken, adminisztracios_munkatarsak_authJwt.isBossOrAdminOrStudyDepartment], vezerlo.kiosztottDiakokSzamaMsc);
  ...
  utvonal.get("/:id", [adminisztracios_munkatarsak_authJwt.verifyToken, adminisztracios_munkatarsak_authJwt.isAdmin], vezerlo.egyTarifiakcioListazasa);
  ...
  app.use('/api/szakdolgozat_evfolyammunka_tarifikacio/admin', utvonal);
};